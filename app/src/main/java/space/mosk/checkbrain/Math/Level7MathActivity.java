...
public class Level7MathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level7MathActivity.this, AuthActivity.class));
            finish();
        }
        ...
        tx.setText(R.string.levelsevenmath);
        ...
        ans_1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if (counter>=20){
                        Toast.makeText(Level7MathActivity.this, "Конец игры", Toast.LENGTH_SHORT).show();
                    } else {
                        handler();
                        clearBtn(true);
    ...
    public void handler() {
        ...
        if (rand == 0){
            ...
            ans = num2;
            if (num1 < 0){
                tv.setText(new StringBuilder().append(num2 * num1).append(" : (").append(num1).append(")").toString());
            } else {
                tv.setText(new StringBuilder().append(num2 * num1).append(" : ").append(num1).toString());
            }
        }
