...
public class Level11MathActivity extends AppCompatActivity {
    ...
    public void inputDigit(View view) {
        ...
        if (userAns.length() >= String.valueOf(ans).length()){
            ...
            if (counter>=20){
                Toast.makeText(Level11MathActivity.this, "Конец игры", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    public void help(View view) {
        Toast.makeText(this, "У вас недостаточно коинов", Toast.LENGTH_SHORT).show();
    }
    ...
    public void update() {
        ...
        if (rand == 0){
            ...
            num2 = 0;
            while (num1 == 0){
                num1 = getRandom(-10, 10);
            }
            while (num2 == 0){
                num2 = getRandom(-10, 10);
            }
            ans = num1 * num2;
            if (num2 < 0){
            ...
            ans = num2;
            if (num1 < 0){
                taskText.setText(num2 * num1 + " : (" + num1 + ") = ");
            } else {
                taskText.setText(num2 * num1 + " : " + num1 + " = ");
            }
        }
