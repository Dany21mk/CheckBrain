...
public class Level6MathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level6MathActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level6MathActivity.this, MathActivity.class));
        ...
        ans_1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if (counter>=20){
                        Toast.makeText(Level6MathActivity.this, "Конец игры", Toast.LENGTH_SHORT).show();
                    } else {
                        handler();
                        clearBtn(true);
