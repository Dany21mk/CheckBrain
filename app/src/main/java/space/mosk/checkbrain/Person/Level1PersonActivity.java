...
public class Level1PersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level1PersonActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level1PersonActivity.this, HisoryActivity.class));
    ...
    public void handler() {
        ...
        while (cnt != 0){
            cnt = 0;
            rand = random.nextInt(array.person1.length);
        ...
        tv.setTextSize(15);
        ans = array.person1Ans[rand];
        tv.setText(array.person1[rand]);
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            answers[i] = array.person1Ans[rand];
            ...
            while (count > 1){
                ...
                answers[i] = array.person1Ans[rnd];
                for (int j = 0; j < answers.length; j++) {
                    if (answers[i] == answers[j]){
                        count++;
                    }
    ...
    public void gameover(){
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(Level1PersonActivity.this, PersonActivity.class));
                finish();
            }
        });
