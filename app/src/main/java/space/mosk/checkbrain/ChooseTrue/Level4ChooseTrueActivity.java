...
public class Level4ChooseTrueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level4ChooseTrueActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level4ChooseTrueActivity.this, ChooseTrueActivity.class));
    ...
    public void handler(){
        ...
        while (cnt != 0){
            cnt = 0;
            num = random.nextInt(array.choose_true4.length);
        ...
        arrayList.add(num);
        text_task.setText(array.choose_true4[num]);
        boolAns = array.chooseTrueAns4[num];
    }
