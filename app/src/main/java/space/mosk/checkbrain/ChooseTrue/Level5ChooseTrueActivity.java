...
public class Level5ChooseTrueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level5ChooseTrueActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level5ChooseTrueActivity.this, ChooseTrueActivity.class));
    ...
    public void handler(){
        ...
        while (cnt != 0){
            cnt = 0;
            num = random.nextInt(array.choose_true5.length);
        ...
        arrayList.add(num);
        text_task.setText(array.choose_true5[num]);
        boolAns = array.chooseTrueAns5[num];
    }
