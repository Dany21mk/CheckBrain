...
import space.mosk.checkbrain.Geog.Level1GeogActivity;
import space.mosk.checkbrain.R;

public class Level1HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level1HistoryActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level1HistoryActivity.this, HisoryActivity.class));
    ...
    public void handler() {
        ...
        while (cnt != 0){
            cnt = 0;
            rand = random.nextInt(array.dates1.length);
        ...
        tv.setTextSize(20);
        ans = array.dates1Ans[rand];
        tv.setText(array.dates1[rand]);
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            answers[i] = array.dates1Ans[rand];
