...
public class Level2HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level2HistoryActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level2HistoryActivity.this, HisoryActivity.class));
    ...
    public void handler() {
        rand = random.nextInt(array.dates2.length);
        tv = findViewById(R.id.task);
        tv.setTextSize(25);
        ans = array.dates2Ans[rand];
        tv.setText(array.dates2[rand]);
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            answers[i] = array.dates2Ans[rand];
