...
public class Level6GeogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level6GeogActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level6GeogActivity.this, GeogActivity.class));
    ...
    public void handler() {
        rand = random.nextInt(array.popular.length);
        tv = findViewById(R.id.task);
        tv.setTextSize(25);
        ans = array.popularAnswer[rand];
        tv.setText(array.popular[rand]);
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            answers[i] = array.popularAnswer[rand];
            ...
            while (count > 1){
                ...
                answers[i] = array.popularAnswer[rnd];
                for (int j = 0; j < answers.length; j++) {
                    if (answers[i] == answers[j]){
                        count++;
                    }
    ...
    public void gameover(){
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(Level6GeogActivity.this, ChooseTrueActivity.class));
                finish();
            }
        });
