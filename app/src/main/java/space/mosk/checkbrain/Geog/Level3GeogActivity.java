...
public class Level3GeogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level3GeogActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level3GeogActivity.this, GeogActivity.class));
    ...
    public void handler() {
        rand = random.nextInt(array.africa.length);
        tv = findViewById(R.id.task);
        ans = array.africaAnswer[rand];
        tv.setText(array.africa[rand]);
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            answers[i] = array.africaAnswer[rand];
            ...
            while (count > 1){
                ...
                answers[i] = array.africaAnswer[rnd];
                for (int j = 0; j < answers.length; j++) {
                    if (answers[i] == answers[j]){
                        count++;
                    }
    ...
    public void gameover(){
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(Level3GeogActivity.this, ChooseTrueActivity.class));
                finish();
            }
        });
