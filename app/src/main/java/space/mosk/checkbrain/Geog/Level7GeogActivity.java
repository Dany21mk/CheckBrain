...
public class Level7GeogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level7GeogActivity.this, AuthActivity.class));
            finish();
        }
        ...
        ans_1.setTextSize(20);
        ans_2.setTextSize(20);
        ans_3.setTextSize(20);
        ans_4.setTextSize(20);
    ...
    public void handler() {
        ...
        ArrayList<String> masAnswer = new ArrayList<>();
        switch (rand){
            case 0:
                mas.addAll(Arrays.asList(array.europe));
                masAnswer.addAll(Arrays.asList(array.europeAnswer));
                break;
            case 1:
                mas.addAll(Arrays.asList(array.asia));
                masAnswer.addAll(Arrays.asList(array.asiaAnswer));
                break;
            case 2:
                mas.addAll(Arrays.asList(array.africa));
                masAnswer.addAll(Arrays.asList(array.africaAnswer));
                break;
            case 3:
                mas.addAll(Arrays.asList(array.america));
                masAnswer.addAll(Arrays.asList(array.americaAnswer));
                break;
            case 4:
                mas.addAll(Arrays.asList(array.australia));
                masAnswer.addAll(Arrays.asList(array.australiaAnswer));
                break;
            default:
                mas.addAll(Arrays.asList(array.popular));
                masAnswer.addAll(Arrays.asList(array.popularAnswer));
                break;
        }



        rand = random.nextInt(mas.size());
        tv = findViewById(R.id.task);
        ans = masAnswer.get(rand);
        tv.setText(mas.get(rand));
