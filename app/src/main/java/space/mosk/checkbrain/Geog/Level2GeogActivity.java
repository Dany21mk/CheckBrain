...
public class Level2GeogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null){
            startActivity(new Intent(Level2GeogActivity.this, AuthActivity.class));
            finish();
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Level2GeogActivity.this, GeogActivity.class));
    ...
    public void handler() {
        rand = random.nextInt(array.asia.length);
        tv = findViewById(R.id.task);
        ans = array.asiaAnswer[rand];
        tv.setText(array.asia[rand]);
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            answers[i] = array.asiaAnswer[rand];
            ...
            while (count > 1){
                ...
                answers[i] = array.asiaAnswer[rnd];
                for (int j = 0; j < answers.length; j++) {
                    if (answers[i] == answers[j]){
                        count++;
                    }
